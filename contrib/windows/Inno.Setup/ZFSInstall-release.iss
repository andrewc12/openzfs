...
Source: "{#Root}\out\build\x64-Release\cmd\os\windows/kstat/kstat.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "{#Root}\out\build\x64-Release\cmd\os\windows/zfsinstaller/zfsinstaller.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "{#Root}\out\build\x64-Release\cmd\zpool\zpool.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "{#Root}\out\build\x64-Release\cmd\zfs\zfs.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "{#Root}\out\build\x64-Release\cmd\zdb\zdb.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "{#Root}\out\build\x64-Release\cmd\zstream\zstreamdump.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "{#Root}\out\build\x64-Release\module\os\windows\driver\OpenZFS.sys"; DestDir: "{app}"; Flags: ignoreversion
Source: "{#Root}\out\build\x64-Release\module\os\windows\driver\OpenZFS.cat"; DestDir: "{app}"; Flags: ignoreversion
Source: "{#Root}\out\build\x64-Release\module\os\windows\driver\OpenZFS.inf"; DestDir: "{app}"; Flags: ignoreversion
Source: "{#Root}\out\build\x64-Release\module\os\windows\driver\OpenZFS.man"; DestDir: "{app}"; Flags: ignoreversion
;Source: "{#Root}\x64\Release\ZFSin.cer"; DestDir: "{app}"; Flags: ignoreversion
;Source: "{#Root}\zfs\cmd\arcstat\arcstat.pl"; DestDir: "{app}"; Flags: ignoreversion
Source: "{#Root}\out\build\x64-Release\module\os\windows\driver\*.pdb"; DestDir: "{app}\symbols"; Flags: ignoreversion
